...
import { getBreakLengthSeries } from "../../../utils/diagramsFuncs"
...
export default function BreakDiagram({
    ...
    mainRef: React.RefObject<HTMLDivElement | null>
        ...
        const { data, groupsDays, effectiveGroup } = useMemo(() => {
            ...
            const fullSeries = getBreakLengthSeries(calendar, days, id)

            const dayIndex = new Map(days.map((d, i) => [d, i]))

            const breakPerGroup: number[] = groupsDays.map(g => {

...
export default function StatsFilters ({ period, setPeriod, metric, setMetric, group, setGroup } : {group: string, period:string, metric: string, setPeriod:React.Dispatch<SetStateAction<string>>, setGroup:React.Dispatch<SetStateAction<string>>, setMetric:React.Dispatch<SetStateAction<string>>}) {
